...
SOCKS5 CONNECT through a selected local Trojan HTTPUpgrade outbound, plus Trojan TLS UDP relay smoke evidence for
...
SOCKS5 CONNECT through a selected local VLESS gRPC outbound, plus VLESS TCP UDP relay smoke evidence for
