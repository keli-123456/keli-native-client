...
SOCKS5 CONNECT through a selected local Trojan TLS outbound, plus AnyTLS TLS TCP relay smoke evidence for
SOCKS5 CONNECT through a selected local AnyTLS TLS outbound, plus HY2 QUIC TCP relay smoke evidence for
...
SOCKS5 CONNECT through a selected local VMess outbound, plus Mieru TCP relay smoke evidence for
SOCKS5 CONNECT through a selected local Mieru outbound, plus UDP relay smoke evidence for
