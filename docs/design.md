...
5. Production readiness: real interop matrix, long soak tests, resource limits,
   ...
   cleanly. The default Trojan TLS UDP relay smoke starts a managed mixed
   ...
   `socks5`/outbound metrics, and stops cleanly. The default Naive H2 TCP relay smoke starts a managed mixed
   ...
   payload round trip, records `socks5`/outbound metrics, and stops cleanly. The default Mieru TCP relay smoke starts a managed mixed
   ...
   `socks5`/outbound metrics, and stops cleanly. The default UDP
   relay smoke starts a managed mixed runtime from a local Shadowsocks
