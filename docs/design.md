...
5. Production readiness: real interop matrix, long soak tests, resource limits,
   ...
   `socks5`/outbound metrics, and stops cleanly. The default VMess gRPC TCP relay smoke starts a managed
   ...
   completes the payload round trip, records `socks5`/outbound metrics, and
   stops cleanly. The default VMess H2 TCP relay smoke starts a managed mixed
   ...
   round trip, records `socks5`/outbound metrics, and stops cleanly. The default VMess QUIC TCP relay smoke starts a managed mixed
   ...
   trip, records `socks5`/outbound metrics, and stops cleanly. The default VMess TCP UDP relay smoke starts a managed mixed
