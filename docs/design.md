...
a cumulative rejection count for long-running resource protection, and
`listen-mixed --max-connection-workers` lets clients tune the cap. Its status
snapshot reports active/peak workers and
