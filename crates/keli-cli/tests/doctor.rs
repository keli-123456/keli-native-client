...
fn doctor_json_report_is_machine_readable() {
    ...
    assert_eq!(
        report["readiness_check_capabilities"][90],
    ...
    assert_eq!(
        report["default_core_certification_capabilities"][90],
        "tun-tcp-session-close-marker-rst-clear-smoke"
    );
    assert_eq!(
    ...
    assert_eq!(
        report["default_core_certification_capabilities"][93],
        "machine-takeover-smoke-mode"
    );
    assert_eq!(
        report["default_core_certification_capabilities"][94],
        "default-core-release-gate"
    );
    assert_eq!(
    ...
    assert_eq!(
        report["default_core_certification_capabilities"][96],
        "default-core-release-gate-stability-window"
    );
    assert_eq!(
        report["default_core_certification_capabilities"][97],
        "default-core-release-gate-stability-traffic-floor"
    );
    assert_eq!(
        report["default_core_certification_capabilities"][98],
        "default-core-release-gate-preset"
    );
    assert_eq!(
        report["default_core_certification_capabilities"][99],
        "default-core-release-gate-preset-evidence"
    );
    assert_eq!(
        report["default_core_certification_capabilities"][100],
    ...
    assert_eq!(
        report["default_core_certification_capabilities"][102],
        "default-core-release-gate-preset-enforced"
    );
    assert_eq!(
        report["default_core_certification_capabilities"][103],
        "default-core-release-gate-preset-scope"
    );
    assert_eq!(
        report["default_core_certification_capabilities"][104],
        "default-core-release-gate-takeover-evidence"
    );
    assert_eq!(
        report["default_core_certification_capabilities"][105],
    ...
    assert_eq!(
        report["default_core_certification_capabilities"][107],
        "default-core-release-gate-rerun-args"
    );
    assert_eq!(
        report["default_core_certification_capabilities"][108],
