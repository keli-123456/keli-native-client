...
fn doctor_report_lists_supported_outbounds() {
    ...
    assert!(output.contains(
        "supported_udp_outbounds=direct,socks5-udp,vmess-tcp-aead-udp,vmess-tls-tcp-aead-udp,vmess-ws-aead-udp,vmess-tls-ws-aead-udp,vmess-httpupgrade-aead-udp,vmess-tls-httpupgrade-aead-udp,shadowsocks-aead,hy2-quic,tuic-quic"
    ));
}
