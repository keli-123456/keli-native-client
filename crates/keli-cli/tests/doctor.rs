...
fn doctor_json_report_is_machine_readable() {
    ...
    assert_eq!(report["readiness_check_capabilities"][7], "tun-preflight");
    assert_eq!(
        report["readiness_check_capabilities"][9],
        "system-proxy-smoke"
    );
    assert_eq!(
    ...
    assert_eq!(report["readiness_check_capabilities"][13], "json-gates");
    assert_eq!(
