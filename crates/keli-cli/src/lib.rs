...
const SUPPORTED_OUTBOUNDS: &str =
    "direct,trojan-tcp,trojan-ws,trojan-httpupgrade,trojan-grpc,vless-tcp,vless-ws,vless-httpupgrade,vless-grpc,vmess-tcp,vmess-ws,vmess-httpupgrade,vmess-grpc,shadowsocks-tcp,anytls-tls-tcp,naive-h2-tcp,mieru-tcp,hy2-quic,tuic-quic";
