...
pub fn managed_tun_runtime_report_note(report: &ManagedTunPacketLoopReport) -> String {
    ...
    format!(
        "managed TUN runtime stopped interface={} owns_device={} processed={} idle={} dns_responses={} udp_responses={} tcp_resets={} tcp_session_events={} tcp_session_writes={} tcp_sessions_pruned={} tcp_server_closed_pruned={} tcp_post_closed_pruned={} relay_plans={} tcp_relay_plans={} udp_relay_plans={} drops={} unsupported={} packet_errors={} udp_relay_errors={} tcp_session_errors={} last_packet_error={} last_udp_relay_error={} last_tcp_session_error={}",
