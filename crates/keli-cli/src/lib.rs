...
const SUPPORTED_OUTBOUNDS: &str =
    "direct,trojan-tcp,trojan-ws,trojan-httpupgrade,trojan-grpc,trojan-h2,vless-tcp,vless-ws,vless-httpupgrade,vless-grpc,vless-h2,vmess-tcp,vmess-ws,vmess-httpupgrade,vmess-grpc,vmess-h2,shadowsocks-tcp,anytls-tls-tcp,naive-h2-tcp,mieru-tcp,hy2-quic,tuic-quic";
