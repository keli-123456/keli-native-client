...
const SUPPORTED_OUTBOUNDS: &str =
    "direct,trojan-tcp,trojan-ws,trojan-httpupgrade,vless-tcp,vless-ws,vless-httpupgrade,vmess-tcp,vmess-ws,vmess-httpupgrade,shadowsocks-tcp,anytls-tls-tcp,naive-h2-tcp,mieru-tcp,hy2-quic,tuic-quic";
