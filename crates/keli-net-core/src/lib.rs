...
pub use quic::{
    ...
    tuic_authenticate_command, tuic_export_token, validate_hy2_auth_response, Hy2BlockingTcpStream,
    Hy2ClientSession, Hy2H3Connection, Hy2H3SendRequest, Hy2QuicTcpStream,
};
pub use socks5::{
