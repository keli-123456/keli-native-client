...
pub use tun::{
    ...
    plan_tun_packet_relay, process_tun_device_packet,
    ...
    RegistryTunUdpRelay, TunDnsHijackPlan, TunDnsHijackResponse, TunIpVersion, TunPacketDevice,
    TunPacketError, TunPacketFlow, TunPacketLoopError, TunPacketLoopEvent, TunPacketLoopSummary,
